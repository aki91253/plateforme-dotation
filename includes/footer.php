  ...
  <!-- ClipPath nécessaire pour le style squircle -->
...
<div class="relative">
  ...
  <div class="relative flex items-end gap-x-4 p-4">
    ...
    <a href="https://www.facebook.com/canopecorse/?_rdr" target="_blank">
      <div
        style="clip-path: url(#squircleClip)"
        class="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center shadow-lg border border-blue-500/50 cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl"
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6 text-white" viewBox="0 0 24 24">
    ...
    <a href="https://www.youtube.com/@crdpcorse" target="_blank">
      <div
        style="clip-path: url(#squircleClip)"
        class="w-14 h-14 bg-gradient-to-br from-red-600 to-red-800 rounded-xl flex flex-col items-center justify-center shadow-lg border border-red-500/50 cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl"
      >
        <!-- Logo triangle -->
        <svg viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-white mb-1" xmlns="http://www.w3.org/2000/svg">
