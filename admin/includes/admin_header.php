        ...
        <aside id="admin-sidebar" class="admin-sidebar w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full shadow-sm">
            ...
            <nav class="flex-1 py-6">
              ...
              <!-- Other -->
                ...
                <p class="px-6 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Options</p>
                <ul class="space-y-1 px-3">
                    <li>
                        <a href="setting.php" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-xl border-l-4 border-transparent text-gray-500">
