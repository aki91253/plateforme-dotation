        ...
        <aside id="admin-sidebar" class="admin-sidebar w-64 bg-canope-slate border-r border-white flex flex-col fixed h-full shadow-sm">
            ...
            <nav class="flex-1 py-6">
                ...
                <ul class="space-y-1 px-3">
                    ...
                    <li>
                    <a href="maintenance.php" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-xl border-l-4 border-transparent text-white <?= $currentPage === 'database_backup' ? 'active' : '' ?>">
