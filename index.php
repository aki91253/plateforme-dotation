...
<div class="max-w-5xl mx-auto px-4 sm:px-5 py-6 sm:py-8">
    <section class="text-center py-8 sm:py-12">
        <span class="inline-block bg-white/20 backdrop-blur-sm text-white text-xs sm:text-sm font-medium px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-white/30">
  Réseau Canopé – Corse
</span>
        <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal mb-4 sm:mb-6 md:mb-8 leading-tight text-canope-light px-2">Dotations pédagogiques pour les établissements corses</h1>
        <p class="text-white/80 text-xs sm:text-sm px-4 sm:px-0">Accédez à notre catalogue de ressources et équipements pédagogiques.</br> Faites votre demande en ligne et suivez son traitement en temps réel. </p>
</br>
        <!-- section des boutons -->
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8 px-4 sm:px-0">
            ...
            <div class="relative group">
                ...
                >
                    ...
                    ></span>
                    <span class="relative z-10 block px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-canope-slate">
        ...
        <!-- image de bienvenue -->
        <div class="flex justify-center mt-6 sm:mt-8 px-4 sm:px-0">
            <div class="bg-gray-900 rounded-2xl sm:rounded-[40px] p-3 sm:p-5 shadow-2xl max-w-4xl animate-slide-up">
    ...
    <div class="text-center mb-8 sm:mb-12 px-4">
      <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-canope-light mb-3 sm:mb-4">Comment ça marche ?</h2>
      <p class="text-white/80 text-xs sm:text-sm">Un processus simple et transparent pour accéder aux ressources Canopé</p>
    </div>
