...
<!-- Hero Section -->
<div class="bg-gradient-to-br from-canope-green via-canope-olive to-emerald-600 py-20 px-5">
...
<div class="max-w-6xl mx-auto px-5 py-16">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
            <span class="inline-block px-4 py-1 bg-canope-green/10 text-canope-green rounded-full text-sm font-medium mb-4">Qui sommes-nous ?</span>
...
<!-- Stats Section -->
<div class="bg-gradient-to-r from-canope-green to-canope-olive py-16">
    <div class="max-w-6xl mx-auto px-5">
...
<div class="max-w-4xl mx-auto px-5 py-16">
    <div class="bg-white rounded-2xl border-2 border-gray-100 p-8 md:p-12 text-center shadow-lg">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="donations.php" class="inline-flex items-center justify-center gap-2 bg-canope-green text-white px-6 py-3 rounded-full font-semibold hover:bg-canope-olive transition-colors shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                </svg>
                Voir les dotations
            </a>
            <a href="support.php" class="inline-flex items-center justify-center gap-2 bg-gray-100 text-gray-700 px-6 py-3 rounded-full font-semibold hover:bg-gray-200 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
